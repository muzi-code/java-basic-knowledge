...
@Service("postPushProcessor")
public class PostPushProcessor extends AbstractProcessor implements ProcessHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(PostPushProcessor.class);
