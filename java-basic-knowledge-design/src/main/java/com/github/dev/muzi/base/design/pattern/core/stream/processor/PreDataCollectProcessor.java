...
@Service("preDataCollectProcessor")
public class PreDataCollectProcessor extends AbstractProcessor implements ProcessHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(PreDataCollectProcessor.class);
