...
/**
 * @author lifuyi8
 * @since 2021/4/26 8:45 下午
 */
public class Exercise16_KMP {

    public static int patternFirstChildText(String haystack, String needle) {
        if (needle.length() == 0)
            return 0;
        int i = 0;
        int j = 0;
    ...
    public static void main(String[] args) {
        String content = "你好你早上超级烦了吗，你好在没说话，你是什么你是谁你在哪呢，在家了吗在家了吗你是谁你是，你到底是谁你是谁你是谁呢？";
        int a = patternFirstChildText(content, "你是谁你是");
        System.out.println(a);
        System.out.println(content.substring(a, a + 5));
    }
}
